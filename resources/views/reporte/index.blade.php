...
<body>
        ...
        <table width="100%" class="tabla1">
            <tr>
                <td width="73%" align="center" class="fondo"><img id="logo" src="{{ asset('images/logoathleticarg.jpg') }}" alt="" width="150" height="87"></td>
            ...
            <tr>
                ...
                <td align="center" style="border:0;">
                    <table width="300" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="center" class="leyenda">Cotización válida por 7 días hábiles.</td>
                        </tr>
                    </table>
                </td>
            </tr>
